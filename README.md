...
1. **Extend `RealRobotProfile`** in `src/main/java/frc/robot/RealRobotProfile.java` and fill in your robot's measurements and CAN IDs (the file has TODO comments guiding you):
