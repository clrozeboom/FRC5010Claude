...
| **Guided lesson plan — build a team robot end to end (swerve + 2-motor elevator + LEDs), with deep-dive links per lesson** | [docs/lessons/build-your-robot.md](docs/lessons/build-your-robot.md) |
